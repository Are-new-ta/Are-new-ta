<h2 align="center"><b>Привет! <img src="https://emojipedia-us.s3.amazonaws.com/source/skype/289/victory-hand_270c-fe0f.png" width="40" alt="Рука в приветственном жесте">
<br>
...
<h2>🧘‍♂ О себе:</h2>
Получила диплом об успешном завершении курса от Яндекс.Практикум по Web-разработке. Совмещаю работу и поиск подходящей вакансии в IT сфере.
Люблю читать антиутопии, смотреть авторское кино, JavaScript и React) Также читаю книги по основам веб-разработки, документацию на английском языке и
решаю задачи на Codewars. Занимаюсь созданием сайта-резюме, хочу на нативном JavaScript реализовать виртуальную клавиатуру и игру «Сапёр».
